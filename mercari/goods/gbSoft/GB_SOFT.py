...
SEARCH_URL = os.environ['MRCR_GB_SOFT_SEARCH_URL']
LOOP_LIMIT = int(os.environ['MRCR_GB_SOFT_LOOP_LIMIT'])
PRICE_UPPER_LIMIT = int(os.environ['MRCR_GB_SOFT_PRICE_UPPER_LIMIT'])
PRICE_LOWER_LIMIT = int(os.environ['MRCR_GB_SOFT_PRICE_LOWER_LIMIT'])
